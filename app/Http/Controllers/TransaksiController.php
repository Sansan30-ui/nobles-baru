...
class TransaksiController extends Controller
{
    ...
    public function payment(Request $request)
    {
        ...
        return view('pages.transaction.payment', ['hargaOngkir' => $hargaOngkir, 'provinsi' => $provinsi, 'kabupaten' => $kabupaten, 'kecamatan' => $kecamatan, 'desa' => $desa, 'products' => $products, 'keranjang' => $keranjang,  'kodeUnik' => $kodeUnik]);
    }
    ...
    public function transaksi()
    {
        ...
        $data = DB::table('transaksi')->groupBy('kode_pembayaran')->get();
    ...
    {
        // dd('ad');
        $data = Transaksi::where('kode_pembayaran', $kode)->update([
